                ...
                <div class="tab-content d-flex flex-grow-1" id="v-tab-tabContent">
                    ...
                    <div class="tab-pane fade show active w-100" id="v-tab-profile" role="tabpanel">
                        <h4>Patients</h4>
                            <ul>
                                <div v-if="patients">
                                    <div v-if="patients.contact_number.length == 0">
                                        <p>Nothing to show</p>
                                    </div>

                                    <div v-else v-for="patient in patients.contact_number" class = "d-flex flex-column px-5 m-3">
                        ...
                        <h4>Doctors</h4>
                            <ul>
                                <div v-if="doctors" v-for="doctor in doctors.contact_number" class = "d-flex flex-column px-5 m-3">
                    ...
                    <div class="tab-pane fade w-100" id="v-tab-messages" role="tabpanel">
                        <h4>Patients</h4>
                            <ul>
                                <div v-if="patients" v-for="patient in patients.email" class = "d-flex flex-column px-5 m-3">
                                    <!-- card for each patient  -->
                                    <div class = "card d-flex flex-row w-100 h-auto shadow-sm hover-shadow" >
                                        <!-- photo container  -->
                                        <div class = "col-3 d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h4>Doctors</h4>
                            <ul>
                                <div v-if="doctors" v-for="doctor in doctors.email" class = "d-flex flex-column px-5 m-3">
                                    <!-- card for each doctor  -->
                                    <div class = "card d-flex flex-row w-100 h-auto shadow-sm hover-shadow" >
                                        <!-- photo container  -->
                                        <div class = "col-3 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="tab-pane fade w-100" id="v-tab-settings" role="tabpanel">
                        <h4>Patients</h4>
                            <ul>
                                <div v-if="patients" v-for="patient in patients.name" class = "d-flex flex-column px-5 m-3">
                                    <!-- card for each patient  -->
                                    <div class = "card d-flex flex-row w-100 h-auto shadow-sm hover-shadow" >
                                        <!-- photo container  -->
                                        <div class = "col-3 d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h4>Doctors</h4>
                            <ul>
                                <div v-if="doctors" v-for="doctor in doctors.name" class = "d-flex flex-column px-5 m-3">
                                    <!-- card for each doctor  -->
                                    <div class = "card d-flex flex-row w-100 h-auto shadow-sm hover-shadow" >
                                        <!-- photo container  -->
                                        <div class = "col-3 d-flex flex-column justify-content-center align-items-center">
