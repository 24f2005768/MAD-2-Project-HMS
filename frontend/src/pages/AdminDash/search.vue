                ...
                <div class="tab-content d-flex flex-grow-1" id="v-tab-tabContent">
                    ...
                    <div class="tab-pane fade show active w-100" id="v-tab-home" role="tabpanel">
                        <h4 class = "px-3">Patients</h4>
                            <ul class = "p-0">
                                <div v-if="patients">
                                    <div v-if="patients.ID.length == 0" class = "d-flex align-items-center justify-content-center" style="height: 200px;">
                                        <p>Nothing to show</p>
                                    </div>

                                    <div v-else v-for="patient in patients.ID" class = "d-flex flex-column m-3">
                        ...
                        <h4 class = "px-3">Doctors</h4>
                            <ul class = "p-0">
                                <div v-if="doctors">
                                    <div v-if="doctors.ID.length == 0" class = "d-flex align-items-center justify-content-center" style="height: 200px;">
                                        <p>Nothing to show</p>
                                    </div>

                                    <div v-else v-for="doctor in doctors.ID" class = "d-flex flex-column m-3">
                                        ...
                                        <div class = "card d-flex flex-row w-100 h-auto shadow-sm hover-shadow" >
                                            ...
                                            <div class = "col-9 d-flex align-items-center">
                                                <div class = "d-flex flex-column m-2">
                                                    <div><p><strong>ID: </strong>{{ doctor.doctor_id }}</p></div>
                        ...
                        <h4 class = "px-3">Departments</h4>
                            <ul class = "p-0">
                                <div v-if="departments">
                                    <div v-if="departments.ID.length == 0" class = "d-flex align-items-center justify-content-center" style="height: 200px;">
                                        <p>Nothing to show</p>
                                    </div>

                                    <div v-else v-for="dept in departments.ID" class = "d-flex flex-column m-3">
                                        ...
                                        <div class = "card d-flex flex-row w-100 h-auto shadow-sm hover-shadow" >
                                            ...
                                            <div class = "col-9 d-flex align-items-center">
                                                <div class = "d-flex flex-column m-2">
                                                    <div><p><strong>ID: </strong>{{ dept.department_id }}</p></div>
