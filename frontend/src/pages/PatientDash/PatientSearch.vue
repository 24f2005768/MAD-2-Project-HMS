            ...
            <div class = "w-100 d-flex justify-content-end">
             ...
             <div class = 'col w-75 mx-auto'>
                ...
                <div class="tab-content d-flex flex-grow-1" id="v-tab-tabContent">
                    ...
                    <!-- Name  -->
                    <div class="tab-pane fade show active w-100" id="v-tab-settings" role="tabpanel">
    ...
    export default {
        ...
        methods: {
            async getSearchResults(query) { 
                const search_results = await requestAPI('GET', null, `/patient/search?query=${query}`)
                ...
                // length 
                this.lengthName = this.doctors.name.length + this.departments.name.length
                this.lengthCN = this.doctors.contact_number.length
                this.lengthEmail = this.doctors.email.length
            }
        },
        ...
        watch: {
            $route(new_route, old_route) {
                if (new_route.name == "patientSearch") {
                    this.getSearchResults(this.$route.params.query)
                }
            }
        }
