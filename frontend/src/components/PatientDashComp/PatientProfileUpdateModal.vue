<template>
    <div class = "modal fade" id = "update-patient-profile-modal" tabindex = "-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form v-if="patient && patient.patient_user" @submit.prevent = "submitForm">
                    <div class="modal-body">
                        <div class = "col-md row-sm mb-3 form-floating form-floating">
                            <input type = "text" class = "form-control" v-model = "patient.patient_user.user_name"
                            id="floatingInput">
                        ...
                        <div class = "col-md row-sm mb-3 form-floating form-floating">
                            <input type = "text" class = "form-control" v-model = "patient.height"
                            id="floatingInput">
                            <label for = "description" class = "form-label">Height</label>
                        </div>
                        
                        <div class = "col-md row-sm mb-3 form-floating form-floating">
                            <input type = "text" class = "form-control" v-model = "patient.weight"
                            id="floatingInput">
...
<script>
    export default {
        name: 'PatientProfileUpdateModal',
        props: {
            patient: {
                type: Object,
                required: true
        ...
        methods: {
            async submitForm() {
                try {
                    const data = {
                        user_name: this.patient.patient_user.user_name,
